<div class="row g-3">
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="form-control form-control-sm"
            value="<?= ucfirst($data['tipe']) ?>" readonly>
    </div>
    <div class="col-md-6">
    ...
    <?php if (!empty($data['no_invoice_dp'])): ?>
    <div class="col-12">
        <div class="alert alert-info py-2 mb-0">
            <div class="row">
                <div class="col-md-4">
                    <small class="text-muted d-block">No. Invoice DP</small>
                    <strong><?= $data['no_invoice_dp'] ?></strong>
                </div>
                <div class="col-md-4">
                    <small class="text-muted d-block">Nilai DP</small>
                    <strong><?= $data['matauang'] ?> <?= number_format($data['nilai_dp'], 2) ?></strong>
                </div>
                <div class="col-md-4">
                    <small class="text-muted d-block">Persentase DP</small>
                    <strong><?= number_format($data['persen_dp'], 2) ?>%</strong>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="form-control form-control-sm text-end"
            value="<?= number_format($data['dpp'], 2) ?>" readonly>
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="form-control form-control-sm text-end"
            value="<?= number_format($data['sisa_nilai'], 2) ?>" readonly>
    </div>
    ...
    <div class="col-12">
        ...
        <a href="<?= base_url('uploads/invoice_il/' . $data['file_invoice']) ?>"

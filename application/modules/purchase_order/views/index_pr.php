	...
	<div class="card-header bg-white d-flex justify-content-between">
		<div class="col-md-2">
			<select class=" form-control" id="filter_status">
				...
				<option value="1" <?= (isset($filter_status) && $filter_status == '1') ? 'selected' : '' ?>>Outstanding</option>
				<option value="2" <?= (isset($filter_status) && $filter_status == '2') ? 'selected' : '' ?>>Partial</option>
			</select>
		</div>
		<div>

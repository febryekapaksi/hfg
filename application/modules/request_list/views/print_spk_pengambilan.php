...
<head>
    <meta charset="UTF-8">
    <title>SPK Pengambilan Coil - <?php echo $spk['spk_no']; ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
                    ...
                    <table class="material-table">
                        <thead>
                            <tr>
                                ...
                                <th>Material Code</th>
                                <th>Material Name</th>
                                <th width="15%" class="text-right">Kebutuhan (Qty)</th>
                                <th width="10%" class="text-center">Unit</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php foreach ($detail['materials'] as $mIdx => $mat): ?>
                                <tr>
                                    <td class="text-center"><?php echo $mIdx + 1; ?></td>
                                    <td><?php echo $mat['id_material']; ?></td>
                                    <td><?php echo $mat['nm_material']; ?></td>
                                    <td class="text-right">
                                        <strong><?php echo number_format((float)$mat['qty'] * $detail['target_qty'], 4); ?></strong>
                                    </td>
                                    <td class="text-center"><?php echo $mat['nm_unit']; ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>

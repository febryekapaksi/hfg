<?php
$ENABLE_VIEW   = has_permission('Confirm_Spk_Coil.View');
...
$(document).ready(function() {
    ...
    var tableSpkCoil = $('#table-spk-coil').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
        ...
        initComplete: function() {
            $('#skeleton-spk-coil').hide();
            $('#content-spk-coil').fadeIn();
        }
    });
